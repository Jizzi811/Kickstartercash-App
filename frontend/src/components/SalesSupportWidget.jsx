    ...
    <div style={{
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "16px" }}>
          <Ticket size={16} style={{ color: "#7C3AED" }} />
            ...
            {done === "error" ? (
              ...
              <>
                ...
                <button onClick={onClose} style={{
                  ...
                  borderRadius: "6px", color: "#7C3AED", cursor: "pointer",
                }}>OK</button>
              </>
            )}
          </div>
          ...
          <>
            ...
            <div style={{ display: "flex", gap: "8px" }}>
              ...
              <button onClick={submit} disabled={!title.trim() || loading} style={{
                flex: 2, padding: "10px",
                background: loading || !title.trim() ? "rgba(124,58,237,0.2)" : "rgba(124,58,237,0.9)",
              ...
              {messages.length === 0 && (
                <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
                  ...
                  <button
                    ...
                    onMouseEnter={(e) => { e.currentTarget.style.background = "rgba(124,58,237,0.13)"; e.currentTarget.style.borderColor = "rgba(124,58,237,0.4)"; }}
                  ...
                  >
                    <Ticket size={16} color="#7C3AED" style={{ flexShrink: 0 }} />
                    <div>
                      <div style={{ color: "#7C3AED", fontWeight: 600, fontSize: "12px" }}>
                  ...
                  <div style={{ marginTop: "4px" }}>
                    ...
                    {suggestions.map((s, i) => (
                      <button key={i} onClick={() => send(s)} style={{
                        ...
                        onMouseEnter={(e) => { e.currentTarget.style.borderColor = "rgba(124,58,237,0.3)"; e.currentTarget.style.color = "#ccc"; }}
              ...
              {loading && (
                <div style={{ display: "flex", gap: "8px", alignItems: "flex-start" }}>
                  ...
                  <div style={{
                    ...
                    {[0, 1, 2].map((j) => (
                      <motion.div key={j} style={{ width: "6px", height: "6px", borderRadius: "50%", background: "#7C3AED" }}
            ...
            <div style={{
              ...
              <button
                ...
                style={{
                  ...
                  background: input.trim() && !loading ? "rgba(124,58,237,0.2)" : "rgba(255,255,255,0.05)",
                  border: `1px solid ${input.trim() && !loading ? "rgba(124,58,237,0.4)" : "rgba(255,255,255,0.1)"}`,
                  cursor: input.trim() && !loading ? "pointer" : "not-allowed",
                  display: "flex", alignItems: "center", justifyContent: "center",
                }}
              >
                {loading ? <Loader2 size={14} color="#7C3AED" className="animate-spin" /> : <Send size={14} color={input.trim() ? "#7C3AED" : "#444"} />}
              </button>
            </div>
          </motion.div>
        )}
