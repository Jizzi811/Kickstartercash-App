        ...
        <div className="lg:col-span-3 space-y-5">
          ...
          <div className="border border-white/8 rounded-sm p-5 space-y-4" style={{ background: "rgba(192,132,252,0.03)" }}>
            <StudioContextArea
              ...
              placeholder="z.B. Luxuriöses KickstarterCash Werbebanner, Gold & Schwarz, moderner Business-Stil…"
              placeholderEN="e.g. Luxurious KickstarterCash advertising banner, gold & black, modern business style…"
              title="Design Studio"
            />
