      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
        <div className="lg:col-span-3 space-y-5">
          <StudioContextArea color={COLOR} context={context} setContext={setContext}
            ...
            placeholder="z.B. Brandmind Cashback-Karte – finanzielle Freiheit für Unternehmer…"
            placeholderEN="e.g. Brandmind cashback card – financial freedom for entrepreneurs…" />
          <div>
