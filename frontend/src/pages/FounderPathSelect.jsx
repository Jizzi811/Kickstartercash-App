...
export default function FounderPathSelect() {
  ...
  return <Page><Hero icon={Sparkles} badge="Brandmind Onboarding" title={copy.title} description={copy.desc} actions={<Btn variant="ghost" onClick={skip}>{copy.skip}</Btn>} />
    <section className="grid gap-4 lg:grid-cols-3">
      ...
      <PathCard icon={Sparkles} title={copy.founder[0]} description={copy.founder[1]} outcome={{ label: copy.outcome, text: copy.founder[2] }} steps={{ label: copy.steps, text: copy.founder[3] }} cta={copy.founder[4]} onClick={() => choose("founder", "start", "/onboarding/founder/start")} />
